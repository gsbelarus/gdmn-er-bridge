...
export type createDomainFunc =
  (attributeName: string, lName: LName, adapter?: AttributeAdapter) => erm.Attribute;
export const gdDomains: { [name: string]: createDomainFunc } = {
  "DGENDER": (attributeName: string, lName: LName, adapter?: AttributeAdapter) =>
  ...
  "DTYPETRANSPORT": (attributeName: string, lName: LName, adapter?: AttributeAdapter) =>
    new erm.EnumAttribute(attributeName, lName, false, [{value: "C"}, {value: "S"}, {value: "R"}, {value: "O"}, {value: "W"}], undefined, [], adapter),
  "GD_DIPADDRESS": (attributeName: string, lName: LName, adapter?: AttributeAdapter) =>
  ...
  "DSTORAGE_DATA_TYPE": (attributeName: string, lName: LName, adapter?: AttributeAdapter) =>
